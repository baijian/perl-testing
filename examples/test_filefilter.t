...
throws_ok { main() } qr/Usage:/, 'main() should give a usage error without any arguments';

throws_ok { main() } qr/Unknow command 'bad command'/, '... or with a bad command given';

my @directories = ( 'music_history',
